...
So I have recently started to try out [Helix](https://helix-editor.com/). I have a used Vim (and Neovim) a little bit, but never actually tried to use it in any meaningful capacity. Helix is a modern alternative that has more sane defaults and should pretty much work out of the box, not requiring a bunch of config and plugins. So far I have been happy with what it offers, but there was one thing I missed from VSCode.
