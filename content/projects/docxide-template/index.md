...
date="2026-02-26"
description="A Rust proc-macro library that generates type-safe structs from Word .docx templates, turning placeholders into compile-time checked fields."
+++
...
* The .docx-files should essentially be a part of the source code.
